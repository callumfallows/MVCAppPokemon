...
namespace PokeMart.Web.ApiTypes
{
    ...
    {
        public CardSetResponse(string code, string ptcgoCode, string name, string series, int totalCards, bool standardLegal, bool expandedLegal, DateTime releaseDate, string symbolUrl, string logoUrl)
        {
            Code = code;
            PtcgoCode = ptcgoCode;
            Name = name;
